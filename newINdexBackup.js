...
var list;
var instrumentsList = ["Electric Guitar", "Acoustic Guitar", "Ukelele", "Piano", "Drum", "Saxophone", "Trumpet", "Trombone", "Tuba", "Mandolin", "vocals", "violin", "Bass", "String Bass", "Keyboard", "Cello", "Clarinet", "Flte", "Bassoon", "Oboe", "french Forn", "Baritone", "Tambourine", "Snare Drum"];
...
app.get('/create', function(req, res) {
    io.on('connection',function(client){
		...
		checkSongs(client.id, "Basson"/*info.instruments*/);
		setTimeout(function(){
